    ...
    private class SendAction extends OneShotBehaviour {
        ...
        public void action() {
            ...
            if (content != null) {
                ...
                AgentPercept res = new AgentPercept(content.contains("stench"), content.contains("breeze"),content.contains("glitter"), content.contains("bump"), content.contains("scream"));
